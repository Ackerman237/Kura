...
| [`04-api-reference/`](04-api-reference/) | [`api-contracts.md`](04-api-reference/api-contracts.md) | Spesifikasi fungsi publik ekspor, parameter input, validasi bounds, dan bentuk normalized DTO. |
